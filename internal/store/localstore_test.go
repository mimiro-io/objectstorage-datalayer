...
func TestLocalstore(t *testing.T) {
	...
	g.Describe("The localstore backend", func() {
		g.It("Should list files in folder", func() {
			...
			expected := "../../resources/test/data/changes-1.json,../../resources/test/data/changes-2.json,../../resources/test/data/changes-3.json,../../resources/test/data/flatfile-changes-1.txt,../../resources/test/data/flatfile-changes-2.txt,../../resources/test/data/flatfile-changes-3.txt,../../resources/test/data/prima-test1.csv,../../resources/test/data/primatest2.csv,../../resources/test/data/s3-test-1.json,../../resources/test/data/s3-test-1v2.json,../../resources/test/data/s3-test-2.json,../../resources/test/data/s3-test-3.json,../../resources/test/data/stripped.ndjson,../../resources/test/data/unstripped.ndjson"
